...
print(pat)
print(pat.get("first") +" " +pat.get("last"))
...
print(f"{pat.get("first")} and {brian.get("first")} and {steve.get("first")}")
...
PatFeder = {'first': "Patrick", 'last': 'Feder'}
employees.append(PatFeder)
...
print("\nHere are first name values for all dictionaries in our employees list")
